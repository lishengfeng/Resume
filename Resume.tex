...
\item Over 7 years of experience in \textbf{web development}
...
{\textsc{BATON ROUGE, LA}}
{
  ...
  {
    \begin{itemize}
      \item Developed microservice applications for time management, human resource management, project and contract management, and decision-making in the renewable energy industry.
      \item Built a cross-platform mobile application for real estate, integrating intuitive property search and expert inspection functionalities.
      \item Developed a cross-platform app for buying and selling data mining machines, including real-time pricing, profit analysis, and admin portal for machine management, using Firebase for backend services.
      \item Leveraged Kubernetes for enhanced system scalability and resilience, implementing auto-scaling, load balancing, and self-healing mechanisms.
      \item Utilized AWS services including Lambda for serverless architecture and CloudWatch for monitoring, employing infrastructure as code (IaC) principles for efficient cloud resource management.
    \end{itemize}
  }
}
...
{\textsc{BATON ROUGE, LA}}
{
  ...
  {
    \begin{itemize}
      \item Developed a web server using Java, JS, and JSP to manage assignments, collect homework, grade submissions, and provide feedback to over 500 students.
      \item Implemented a professional build environment using Docker and Git, along with a PostgreSQL database.
...
{\textsc{BEIJING, CHINA}}
  {
    ...
    {\vspace{0.1em}
      \begin{itemize}
        ...
        \item Led a team in developing the vending machine control system using Android/Java, resulting in significant revenue growth.
        \item Designed and implemented a remote control and maintenance system for vending machines, significantly reducing operational costs.
...
{\textsc{TOKYO, JAPAN}}
{
  ...
  {
    \begin{itemize}
      \item Designed and implemented complex software for Android devices, including fingerprint processing applications.
      \item Improved application performance using Java Native Interface (JNI).
    \end{itemize}
  }
}
...
\vspace{0.2em}
  ...
  {\textsc{BEIJING, CHINA}}
  {
    ...
    {\vspace{0.1em}
      \begin{itemize}
        \setlength{\itemsep}{0.3em}
        \item Developed user interface components for USB operation, including a complex tree view for navigating USB directories.
        \item Created applications for a movie ticket vending machine and a daily news display.
      \end{itemize}
    }
  }
...
\roottitle{Skills}
\begin{itemize}
  \item \textbf{Programming Languages:} Java, Python, C, JavaScript (JSP, HTML, CSS)
  \item \textbf{Software Development:} Android app development, web development (Spring, Hibernate), embedded system design
  \item \textbf{System Design:} Scalable, resilient systems with Kubernetes, multi-tenant architectures, microservices with domain-driven design
  \item \textbf{Cloud Platforms:} AWS (Lambda, CloudWatch), Azure, Aliyun
