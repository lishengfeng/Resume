...
\item 5+ years \textbf{Java and Android App Design and Implementation}, including 2 years R\&D Experience at \textbf{Fujitsu, Tokyo, Japan}.
\item 2 years in \textbf{Web development}, 1 year in \textbf{Python}
 \item Experienced in \textbf{Agile} and professional software development cycle (API design, version control, peer code review, unit testing)   
\end{itemize}
% \roottitle{Objective}
...
{\textsc{Baton Rouge, LA}}
{
  ...
  {23 December 2019 - Present}
  {
    \begin{itemize}
    \item Built a microservice application for time management (Java, JS, Thymeleaf) helping industries analyze timesheet, manage time allocation and do the report.
    \end{itemize}
  }
}
...
{\textsc{Baton Rouge, LA}}
{
  \headedsubsection
  {Senior Software Engineer}
  {22 August 2019 - 20 December 2019}
  {
    \begin{itemize}
    \item Built a microservice application for time management (Java, JS, Thymeleaf) helping industries analyze timesheet, manage time allocation and do the report.
    \end{itemize}
...
{\textsc{Baton Rouge, LA}}
{
  ...
  {
    \begin{itemize}
    \item Built a web server from scratch (Java, JS, JSP) helping more than 10 high schools manage assignment, collect homework, grade, and give feedback to students. More than 500 students are using the system to submit their homework now. Created professional build environment (Docker, Git), and database (PostgreSQL). The system, already successful, is designed to be maintained and expanded over many years. 
    \item Assisted in gathering, organizing, and showing data to teachers
    \item Designed an easy-to-use process to allow teachers to edit content.
    \end{itemize}
  }
}
...
{\textsc{Beijing, China}}
  {
    ...
    {\vspace{0.1em}
      ...
      \item Technical lead over five software engineers using Android/Java with multiple vending machine platforms
      \item Designed the architecture for the software build process and used Gradle to automatically manage and adapt user interfaces for small and large devices and different protocols. Implemented features for vending machines embedded in Android systems resulting in more than 300k dollars for the company.
      \item Conceived, designed, and implemented a remote control and maintenance system for vending machines allowing remote administration, and thus reducing maintenance and travel costs by 90\%.
...
{\textsc{Tokyo, Japan}}
{
  ...
  {Apr 2014 - Feb 2016}
  {
    ...
    \item Diagnosed and troubleshot problems and applied solutions (by using Java Native Interface) to increase the speed of several applications.
    \item Went from zero to fluent Japanese in two years.
...
\vspace{0.2em}
  ...
  {\textsc{Beijing, China}}
  {
    ...
    {\vspace{0.1em}
      \begin{itemize}
        \setlength{\itemsep}{0.3em}
      \item Designed and implemented the UI of USB operation screen. Designed the structure and the interface of the project. Implemented an algorithm to meet the complex requirements of a tree view for USB directories.
       
      \item Designed and implemented an application for a movie ticket vending machine.
...
Others: Linux/Unix Shell, Python, Maven, Docker, C, Machine Learning, Deep learning, Embedded development
% \begin{tabular}{ll}
