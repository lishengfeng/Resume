...
{\textsc{BATON ROUGE, LA}}
{
  ...
  {
    \begin{itemize}
      \item Enhanced system scalability and resilience by proficiently leveraging Kubernetes, implementing auto-scaling, load balancing, and self-healing mechanisms to optimize resource utilization and ensure system availability.
