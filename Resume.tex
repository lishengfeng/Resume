...
\roottitle{Skills}
Web development(JS/JSP/HTML/CSS/Hibernate/Spring), Java, Version Control (Git), Linux/Unix Shell, Database(SQL/Postgresql),
Android, C, Python, Maven, Docker, Machine Learning, Deep learning, Embedded development
% \begin{tabular}{ll}
