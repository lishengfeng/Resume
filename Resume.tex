...
\roottitle{Skills}
Android, Java, C, Python, Version Control (Git), Linux/Unix Shell, Database(SQL/Postgresql),
Maven, Docker, Web development(JS/JSP/HTML/Hibernate), Embedded development, Machine Learning, Deep learning
% \begin{tabular}{ll}
