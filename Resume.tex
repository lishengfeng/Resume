...
\item  R\&D Experience across \textbf{Fujitsu, Tokyo, Japan}.
\end{itemize}
% \roottitle{Objective}
...
{\textsc{Baton Rouge, LA}}
{
  ...
  {
    \begin{itemize}
    \item Build a back-end web server helping teacher collect homework
    \item Design some patterns that teachers can easily use to update website content without knowing programming
...
{\textsc{Beijing, China}}
  {
    ...
    {\vspace{0.1em}
      ...
      \item Designed and implemented remote control and maintain system for vending machine reducing a lot of maintaining fee.
...
{\textsc{Tokyo, Japan}}
{
  ...
  {
    \begin{itemize}
    \item Designed and implemented complex software for Android devices, including an app for processing fingerprints.
...
\roottitle{Skills}
Android, Java, C, Python, Version Control (Git), Linux/Unix Shell, Machine
Learning, Deep learning, Database(SQL), Web development(JS/JSP/HTML/Hibernate), Embedded development
% \begin{tabular}{ll}
