...
\item Senior Software Engineer with over 10 years of experience in software development, specializing in designing and implementing scalable and resilient systems. Proficient in cloud services, microservices architecture, DevOps practices, and a strong advocate for driving innovation, cross-team collaboration, and continuous improvement.
\end{itemize}
% \roottitle{Objective}
...
{\textsc{BATON ROUGE, LA}}
{
  ...
  {May 2019 - Present}
  {
    \begin{itemize}
      ...
      \item Mentored junior engineers and led code reviews to ensure high-quality software development practices.
    \end{itemize}
  }
}
...
{\textsc{BATON ROUGE, LA}}
{
  ...
  {Sep 2017 - May 2019}
  {
    \begin{itemize}
      ...
      \item Collaborated with cross-functional teams to define project requirements and deliverables.
    \end{itemize}
  }
}
...
{\textsc{BEIJING, CHINA}}
  {
    ...
    {\vspace{0.1em}
      \begin{itemize}
        ...
        \item Established a continuous integration and deployment pipeline using Gradle for automated builds, improving software quality and team productivity.
        \item Designed and implemented a remote control and maintenance system for vending machines, significantly reducing operational costs and enhancing service efficiency.
        \item Coordinated with stakeholders to ensure alignment on project goals and timelines.
      \end{itemize}
    }
  }
...
{\textsc{TOKYO, JAPAN}}
{
  ...
  {Apr 2014 - Feb 2016}
  {
    \begin{itemize}
      ...
      \item Worked closely with product management to translate business requirements into technical specifications.
    \end{itemize}
  }
}
  ...
  {\textsc{BEIJING, CHINA}}
  {
    ...
    {\vspace{0.1em}
      \begin{itemize}
        ...
        \item Engaged in continuous learning and professional development to stay current with industry trends.
      \end{itemize}
    }
  }
